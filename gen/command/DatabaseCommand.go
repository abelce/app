...
func NewDatabaseCommand(basePath string, entities []*model.Entity) DatabaseCommand {
...
func GenerateDatabase(databaseDir string, entity *model.Entity) {
	GenerateSql(databaseDir, entity)
}

// 生成productdb.sql
func GenerateSql(databaseDir string, entity *model.Entity) {
...
// 生成Dockerfile
func GenerateDockerfile(databaseDir string, entity *model.Entity) {
...
// 生成docker.sh
func GenerateDockerSH(databaseDir string, entity *model.Entity) {
