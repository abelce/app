...
func NewModelCommand(basePath string, entities []*model.Entity) ModelCommand {
	return ModelCommand{
		BasePath: basePath,
		Entities: entities,
	}
...
func GenerateModel(modelPath string, entity *model.Entity) {
...
func generateStruct(modelPath string, entity *model.Entity) {
...
// 获取结构体的内容
func getStructBody(entity *model.Entity) template.HTML {
	var result []string
...
// 添加业务对象crud代码
func appendEntityCrudCode(entity *model.Entity) string {
	var result []string
...
func renderTemplate(tplPath string, entity *model.Entity) string {
